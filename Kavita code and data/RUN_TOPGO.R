...
load("entrez_annot.Rda") #mapping GO to  (entrez id)Genes
load("found_genes.Rda") #gene symbols
load("found_genes_wang.Rda")#gene symbols

#find the overlap between found_genes and all_genes (same length as
#all_genes!)
...
PsampleGOdata <- new("topGOdata",description = "Simple session",
                     ...
                     GO2genes = entrez_annot)#why entrez if others are symbol?
